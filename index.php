...
<head>
    ...
    <title>SPK Pemilihan Jurusan Kuliah - Dashboard</title>
        ...
        <ul class="navbar-nav bg-gradient sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php?page=dashboard">
                <div class="sidebar-brand-icon p-2">
                    ...
                    <img src="assets/img/sma1.png" alt="" class="img-profile w-100">
                </div>
                <div class="sidebar-brand-text mx-3 text-center font-weight-bold"><br>SPK Pemilihan Jurusan Kuliah</br></div>
            </a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-right my-auto">
                        <span>SPK Pemilihan Jurusan Kuliah SMAN 1 BANGSAL- 2024</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
