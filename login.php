...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="assets/img/sma2.png">

    <title>SPK Pemilihan Jurusan Kuliah - Login</title>
                            ...
                            <div class="col-lg-6">
                                <div class="p-4 p-sm-5 p-md-5 p-lg-5 p-xl-5">
                                    <div class="text-center">
                                        <img src="assets/img/sma1.png" alt="SMAN ABC" title="SMAN ABC" class="logo d-lg-none mb-2">
                                        <h5 class="text-rose-950 text-uppercase mb-4 d-lg-none"><span>Sistem Pendukung Keputusan</span><br>Pemilihan Jurusan Kuliah</h5>
                                        <p class="h6 text-gray-800 mb-4 d-lg-none">Admin Login</p>
                                        <p class="h5 text-gray-800 mb-4 d-lg-block d-none  font-weight-bold">Admin Login</p>
                                        <!-- <img src="assets/img/sma1.png" alt="" class="img-profile w-25"> -->
                                    </div>
