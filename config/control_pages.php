<?php
	...
	if (isset($_GET['page'])) {
		...
		if ($pages === 'dashboard') {
			...
			// halaman data siswa1
			else if ($pages === 'data_siswa1') {
				include 'pages/data_siswa1/data_siswa1.php';
			}
			else if ($pages == 'tambah_siswa1') {
				include 'pages/data_siswa1/tambah_siswa1.php';
			}
			else if($pages == 'edit_siswa1') {
				include 'pages/data_siswa1/edit_siswa1.php';
			}
