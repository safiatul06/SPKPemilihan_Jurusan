<?php  
    ...
    $querysiswa = mysqli_query($koneksi_db, "SELECT COUNT(nama_siswa) FROM data_siswa1");

    $resKrit = mysqli_fetch_row($queryKrit);
    $resAlt = mysqli_fetch_row($queryAlt);
    $resSub = mysqli_fetch_row($querySub);
    $ressiswa = mysqli_fetch_row($querysiswa);

?>

<!-- Page Heading -->
<div class="d-sm-flex align-items-center justify-content-between mb-3">
    <h1 class="h4 mb-0 text-gray-800 text-uppercase">SPK Menentukan Pemilihan Jurusan Kuliah <br>Metode Simple Additive Weighting (SAW)</h1>
</div>
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="text-md mb-0 text-gray-800">Total <?= $ressiswa[0]; ?></div>
                    </div>
                    <div class="col-auto">
                        <i class="fas fa-folder fa-2x text-gray-300"></i>
                    </div>
