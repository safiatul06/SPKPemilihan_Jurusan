<?php
  ...
  $siswa = mysqli_query($koneksi_db, "SELECT ID_Alter, Nama_Siswa FROM data_alternatif");
	...
	$header = '<div class="head" style="border-bottom: 5px double black; font-family: sans-serif;">	
							<img src="../img/sma1.png" width="100" height="100" style="float: left; margin-right: 15px;">
							<h3 style="float: right; padding-top: 15px;">Laporan Hasil Normalisasi<br>SPK Pemilihan jurusan SMAN ABC</h3>
						</div>'; 
	...
	$mpdf->WriteHTML($date);
	$mpdf->SetFooter('SPK Pemilihan Jurusan|{PAGENO}|Hasil Normalisasi');
